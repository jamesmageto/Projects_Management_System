...
$con=mysqli_connect("localhost","root","1993","projects");
...
// Basic sql query to update a filed in the database to signify that request has been rejected
$result = mysqli_query($con,"UPDATE project SET review='2' WHERE id='$id'");
if (mysqli_error($con))
{
