...
//******************************************************************************
    ...
    var scwBaseYear        = scwDateNow.getFullYear()-110;

    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = 140;
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #EFEFEF;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #EFEFEF;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSource)
        {if (!scwSource) {scwSource = window.event;}
         ...
         if (scwEle.value) {scwDateValue = scwEle.value.replace(/^\s+/,'').replace(/\s+$/,'');  scwEle.focus();}
